...
// tslint:disable newline-per-chained-call no-magic-numbers
    ...
    describe("autoTalkMiddleware", () => {
        describe("ChainTalk", () => {
            it("works", async () => {
                ...
                const autoTalkChooser = builder.state.autoTalkChooser;
                const autoTalkTrigger = builder.state.autoTalkTrigger;
                const ctx = {
