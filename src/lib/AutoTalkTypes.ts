...
import type { AutoTalkChooser } from "./AutoTalkChooser";
import type { AutoTalks } from "./AutoTalks";
...
export type AutoTalkRequestContext<State> = RequestContext<
  State & AutoTalksState<State>
>;

export type AutoTalkRequestCallback<State> = (
  ctx: AutoTalkRequestContext<State>
) => RequestCallbackReturnValue;
...
export type AutoTalkWeight<State> =
  | number
  | ((ctx: AutoTalkRequestContext<State>) => number);
